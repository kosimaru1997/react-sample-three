...
export const SmallSpheres: FC = () => (
  <>
    <SmallSphere x={3} y={1} z={0} />
    <SmallSphere x={2.5} y={1} z={0.5} />
    <SmallSphere x={2} y={1} z={1} />
    <SmallSphere x={1.5} y={1} z={1.5} />
    <SmallSphere x={1} y={1} z={2} />
    <SmallSphere x={0.5} y={1} z={1.5} />
    <SmallSphere x={0} y={1} z={1} />
    <SmallSphere x={3} y={1} z={0} />
    ...
    <SmallSphere x={2} y={1} z={-1} />
    <SmallSphere x={2.5} y={1} z={-0.5} />
    <SmallSphere x={-1} y={1} z={0} />
    <SmallSphere x={3} y={1} z={0} />
    <SmallSphere x={2.5} y={0.5} z={0.5} />
    <SmallSphere x={2} y={0.5} z={1} />
    <SmallSphere x={1.5} y={0.5} z={1.5} />
    <SmallSphere x={1} y={0.5} z={2} />
    <SmallSphere x={0.5} y={0.5} z={1.5} />
    <SmallSphere x={0} y={0.5} z={1} />
    <SmallSphere x={3} y={0.5} z={0} />
    ...
    <SmallSphere x={2} y={0.5} z={-1} />
    <SmallSphere x={2.5} y={0.5} z={-0.5} />
    <SmallSphere x={-1} y={0.5} z={0} />
    <SmallSphere x={2.5} y={0.1} z={0.5} />
    <SmallSphere x={2} y={0.1} z={1} />
    <SmallSphere x={1.5} y={0.1} z={1.5} />
    <SmallSphere x={1} y={0.1} z={2} />
    <SmallSphere x={0.5} y={0.1} z={1.5} />
    <SmallSphere x={0} y={0.1} z={1} />
    <SmallSphere x={3} y={0.1} z={0} />
